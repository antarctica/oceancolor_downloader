...
#
# Created: Wed Feb 18 12:24:24 2015
...
class Ui_OceanData(object):
    def setupUi(self, OceanData):
        ...
        self.btnCancel = QtGui.QPushButton(OceanData)
        self.btnCancel.setEnabled(False)
        self.btnCancel.setObjectName(_fromUtf8("btnCancel"))
        self.horizontalLayout_6.addWidget(self.btnCancel)
        self.btnClose = QtGui.QPushButton(OceanData)
        ...
        QtCore.QObject.connect(self.btnClose, QtCore.SIGNAL(_fromUtf8("clicked()")), OceanData.close)
        QtCore.QObject.connect(self.btnCancel, QtCore.SIGNAL(_fromUtf8("clicked()")), OceanData.stop)
...
"", None))
        ...
        self.btnCancel.setText(_translate("OceanData", "Cancel", None))
        self.btnClose.setText(_translate("OceanData", "Close", None))
